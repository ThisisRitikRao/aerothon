...
import MultiChart_demo_new from '@/components/Multichart_demo_new';
...
const seller = () => {
    ...
    const state = {
      ...
      const data = {
        labels: ['Expiry > 6 months', 'Expiry > 2 years', 'Expiry <= month'],
        datasets: [
          {
            data: [10, 20, 30],
      ...
      const data_material = {
        labels: ['Furniture', 'Art Installations', 'Building Materials','Aircraft Maintenance'],
        datasets: [
          {
            data: [10, 20, 30,20],
            backgroundColor: ['#FF6384', '#36A2EB', '#FFCE56','#3457D5'],
            hoverBackgroundColor: ['#FF6384', '#36A2EB', '#FFCE56','#002244'],
          },
        ],
      };
    ...
    <div className='p-8 lg:px-28'>
        <div className='mt-12'>
            <div className="md:flex justify-between text-white ">
                <div>
                    <div className='text-[1.25rem] slg:text-[1.7rem] lg:text-[2.25rem] font-[600]'>Welcome Back, Manufacturer</div>
    ...
    Apply Filter
            ...
            <div className="lg:flex mt-10 justify-between ">
                    <div className='bg-white rounded-[2rem] mt-10 slg:mt-0'>
                        ...
                        <div className='md:flex box-border h-fit md:h-[15.903rem] w-fill lg:w-[36.538rem] bg-white rounded-[2rem] p-2 drop-shadow-2xl'>

                        <Pie data={data} />

                        {/* data_material */}

                        <Pie data={data_material} />
           ...
           <div className='' style={{ overflowX: 'scroll' }}>
                ...
                <thead>
                    ...
                    <th className="px-4 py-2">List for Sale/Recycle</th>
                ...
                <tbody>
                    ...
                    <button className="bg-[#FDAF4D] font-semibold p-1 text-[1rem] md:text-[1.5rem] font-[600] border rounded-[10px] border-gray-400 rounded shadow text-white">Sale</button>
                    </td>
