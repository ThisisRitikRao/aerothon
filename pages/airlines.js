    ...
    <div className='p-8 lg:px-28'>
        <div className='mt-12'>
            <div className="md:flex justify-between text-white ">
                <div>
                    <div className='text-[1.25rem] slg:text-[1.7rem] lg:text-[2.25rem] font-[600]'>Welcome Back, Airlines</div>
    ...
    Apply Filter
            ...
            <div className="lg:flex mt-10 justify-between ">
                    <div className='bg-white rounded-[2rem] mt-10 slg:mt-0'>
                        ...
                        <div className=' flex box-border h-[15.903rem] w-fill lg:w-[36.538rem] bg-white rounded-[2rem] p-2 drop-shadow-2xl'>
